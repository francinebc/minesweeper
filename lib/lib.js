...
function playSound(filePath){
  ...
  soundSource.setAttribute("src", filePath);
...
// This method asked user for number of rows and number of mines
function setInitParams(){
  // set up two <select> boxes to choose row number and mine number
  // set up "play" button that user hits which will start game
  var notes = document.getElementById('notes');

  // select row num
  var rowNum = document.createElement("input");
  var rowText = document.createTextNode("Number of Rows: ");
  rowNum.setAttribute("id", "rowNum");
  rowNum.setAttribute("type", "number");
  rowNum.setAttribute("min", minRows);
  rowNum.setAttribute("max", maxRows);

  // select mine num
  var mineNum = document.createElement("input");
  var mineText = document.createTextNode("Number of Mines: ");
  mineNum.setAttribute("id", "mineNum");
  mineNum.setAttribute("type", "number");
  mineNum.setAttribute("min", minMines);
  mineNum.setAttribute("max", maxMines);

  // form
  var form = document.createElement("form");
  form.appendChild(rowText);
  form.appendChild(rowNum);
  form.appendChild(mineText);
  form.appendChild(mineNum);
