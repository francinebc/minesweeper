...
function setupButtons(){
  ...
  for(var i=0; i<minsAndMaxes.length; i++){
    ...
    var text = document.createTextNode("Number of " + minsAndMaxes[i][0] + ": ");
    box.setAttribute("id", minsAndMaxes[i][0]);
    box.setAttribute("type", "number");
    box.setAttribute("min", minsAndMaxes[i][1]);
    box.setAttribute("max", minsAndMaxes[i][2]);
